	...
	const projectsData = [
		{
			...
			img: <img src={!mode ? Toon : ToonDark} alt="ToDoTheList on different devices" />,
		...
		},
		{
			...
			img: <img src={!mode ? Mern : MernDark} alt="IFood Renewed Project view on different devices" />,
		...
		},
		{
			...
			img: <img src={!mode ? Metaverse : MetaverseDark} alt="Pet Social Network landing view on different devices" />,
		...
		},
		{
			...
			img: <img src={!mode ? Weather : WeatherDark} alt="Work Time view on different devices" />,
		...
		},
		{
			...
			img: <img src={!mode ? Todo : TodoDark} alt="E-commerce Technological Products view on different devices" />,
		...
		},
		{
			...
			img: <img src={!mode ? Ingrad : IngradDark} alt="FlexBlog website view on different devices" />,
